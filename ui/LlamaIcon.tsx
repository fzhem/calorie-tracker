...
/**
 * Official llama.cpp icon - the llama mascot silhouette.
 * Rendered from the upstream SVG asset with react-native-svg.
 */
export default function LlamaIcon({
  size = 20,
  color = "currentColor",
}: Props) {
  return (
    <Svg width={size} height={size} viewBox="0 0 250 250" fill={color}>
